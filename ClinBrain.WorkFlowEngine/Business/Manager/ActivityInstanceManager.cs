...
namespace ClinBrain.WorkFlowEngine.Business.Manager
{
    ...
    {      
        ...
        /// <param name="activityState"></param>
        /// <returns></returns>
        internal List<ActivityInstanceEntity> GetActivityByState(string processGuid, int processInstanceID,
        string activityGUID,ActivityStateEnum activityState,IDbSession session)
        {
            var sql = @"SELECT * FROM WfActivityInstance 
                        WHERE ProcessInstanceID = @processInstanceID 
                            AND ActivityGUID = @activityGUID 
        ...
        /// <returns></returns>
        internal List<ActivityInstanceEntity> GetActivityByState(string processGuid, int processInstanceID,
        ActivityStateEnum activityState, IDbSession session)
        {
            var sql = @"SELECT * FROM WfActivityInstance 
                        WHERE ProcessInstanceID = @processInstanceID 
                            AND ActivityState = @state
        ...
        /// <param name="activityState"></param>
        /// <returns></returns>
        internal List<ActivityInstanceEntity> GetActivityByProcessInstance(string processGuid, int processInstanceID, IDbSession session)
        {
            var sql = @"SELECT * FROM WfActivityInstance 
                        WHERE ProcessInstanceID = @processInstanceID 
                            AND ProcessGUID = @processGuid
