...
namespace HRMS.WEB.Controllers
{
    public class CommonController : Controller
    {
        ...
        public ActionResult ExcelPreview(string fileName, string filePath)
        {
            ...
            NPOI.SS.Converter1.ExcelToHtmlConverter excelToHtmlConverter = new NPOI.SS.Converter1.ExcelToHtmlConverter();
            // 设置输出参数
...
namespace NPOI.SS.Converter1
{
    ...
    public class ExcelToHtmlConverter
    {
        ...
        protected void ProcessSheet(ISheet sheet)
        {
            ...
            int physicalNumberOfRows = sheet.PhysicalNumberOfRows;   //原码此处有bug，即如果有空白行，会影响后面行的正常显示
            physicalNumberOfRows = sheet.LastRowNum + 1;
